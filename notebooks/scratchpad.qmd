...
ggsave(filename = here("released_outputs", "figures", "deciles_plot_reg_ind_deciles.png"),
       plot = plot_reg_ind_deciles, width = 14, height = 4)
...
plot_reg_ind_age_band_sex_eth <- (plot_reg_ind_age_band / plot_reg_ind_sex / plot_reg_ind_eth)
plot_reg_ind_imd_region <- (plot_reg_ind_imd / plot_reg_ind_region)
plot_reg_ind_care_home_learning_disability <- (plot_reg_ind_care_home / plot_reg_ind_learning_disability)
