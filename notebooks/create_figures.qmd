...
df_plot_measures_bp_hyp <- df_measures_bp_hyp |>
  ...
  mutate(group = factor(group,
    levels = c("population", "sex", "age_band", "ethnicity16", "ethnicity6", "imd_q5", "region", "care_home", "learning_disability"),
    labels = c("Population", "Sex", "Age band", "Ethnicity (16 Groups)", "Ethnicity", "IMD", "Region", "Care home", "Learning disability")
  ))
...
ggsave(
  filename = here("released_outputs", "figures", "figure_bp002_breakdowns.png"),
...
plot_hyp003_population <- df_measures_bp_hyp |>
  ...
  filter(group == "population") |>
  filter(subgroup != "missing") |>
  plot_qof_values(date_breaks = x_scale_date_breaks,
...
ggsave(
  filename = here("released_outputs", "figures", "figure_hyp_counts.png"),
...
ggsave(
  filename = here("released_outputs", "figures", "figure_bp_counts.png"),
