...
ggsave(
  filename = here("released_outputs", "figures", "plot_hyp001_breakdowns.png"),
...
ggsave(
  filename = here("released_outputs", "figures", "plot_hyp003_breakdowns.png"),
...
ggsave(
  filename = here("released_outputs", "figures", "plot_hyp007_breakdowns.png"),
...
ggsave(
  filename = here("released_outputs", "figures", "plot_bp002_breakdowns.png"),
...
plot_hyp003_population <- df_measures_bp_hyp |>
  ...
  filter(category != "missing") |>
  plot_qof_values(
    legend_position = "none", facet_wrap_ncol = 1,
...
ggsave(
  filename = here("released_outputs", "figures", "plot_reg_ind_population.png"),
...
ggsave(
  filename = here("released_outputs", "figures", "plot_breakdown1_hyp003_hyp007.png"),
...
ggsave(
  filename = here("released_outputs", "figures", "breakdown2_hyp003_hyp007.png"),
...
plot_hyp_management_counts <- df_plot_measures_bp_hyp |>
  mutate(variable = case_when(
    indicator == "HYP001 (Total population)" & variable == "register" ~ "numerator",
  ...
  scale_colour_viridis_c(
    name = "Patients receiving\nindicated care (%)",
    option = "mako",
    direction = -1, end = .8
  ) +
  geom_point(aes(x = date, y = numerator), size = 2) +
  geom_point(aes(x = date, y = denominator), size = 2) +
  labs(x = NULL, y = "Numerator / Denominator") +
...
plot_hyp_records_counts <- df_plot_measures_bp_hyp |>
  ...
  scale_colour_viridis_c(
    name = "Hypertension register (%)",
    option = "mako",
    direction = -1, end = .8
  ) +
  geom_point(aes(x = date, y = numerator), size = 2) +
  geom_point(aes(x = date, y = denominator), size = 2) +
  labs(x = NULL, y = "Register / Population") +
  scale_x_date(date_breaks = "4 month", labels = scales::label_date_short()) +
  theme(
    text = element_text(size = 14),
    axis.text.x = element_text(size = 10),
...
ggsave(
  filename = here("released_outputs", "figures", "plot_hyp_counts.png"),
...
ggsave(
  filename = here("released_outputs", "figures", "plot_bp_counts.png"),
...
plot_bp002_age_ld <- (plot_bp002_age_band + plot_bp002_learning_disability) &
  theme_classic() &
  labs(x = NULL, y = NULL) &
  theme(
    legend.position = "bottom",
  ...
  scale_y_continuous(labels = scales::percent, limits = c(.7, 1))

ggsave(
  filename = here("released_outputs", "figures", "plot_bp002_age_ld.png"),
  plot = plot_bp002_age_ld, width = 11, height = 7
)


plot_hyp001_hyp003_deciles <- (plot_hyp001_deciles_practice + plot_hyp003_deciles_practice) &
  theme_classic() &
  labs(x = NULL, y = NULL) &
  theme(
    legend.position = "bottom",
...
ggsave(
  filename = here("released_outputs", "figures", "plot_hyp001_hyp003_deciles.png"),
  plot = plot_hyp001_hyp003_deciles, width = 11, height = 7
)
```
