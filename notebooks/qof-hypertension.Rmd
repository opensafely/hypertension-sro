...
tab1_measures_hyp001 <- df_measures_hyp001 %>% 
  ...
  mutate(category = case_when(group == "care_home" ~ as.character(factor(category,
                                                                         levels = c(TRUE, FALSE),
                                                                         labels = c("Yes",
                                                                                    "No"))),
                              group == "learning_disability" ~ as.character(factor(category,
                                                                                   levels = c(TRUE, FALSE),
                                                                                   labels = c("Yes",
                                                                                              "No"))),
                              group == "imd" ~ as.character(factor(category,
                                                                   levels = c(0:5),
                                                                   labels = c("(Missing)",
                                                                              "1 - Most deprived", 
                                                                              "2", "3", "4", 
                                                                              "5 - Least deprived"))),
                              group == "sex" ~ as.character(factor(category,
                                                                   levels = c("F", "M"),
...
tab1_measures_hyp001 <- tab1_measures_hyp001 %>% 
