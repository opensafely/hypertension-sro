...
`r report_measures(df_measures_hyp001, var_value = value, filter_date = "2019-03-01", filter_group = "population", filter_category = "population")` in March 2019, 
`r report_measures(df_measures_hyp001, var_value = value, filter_date = "2020-03-01", filter_group = "population", filter_category = "population")` in March 2020, and 
`r report_measures(df_measures_hyp001, var_value = value, filter_date = "2021-03-01", filter_group = "population", filter_category = "population")` in March 2021.
...
learning disability (
Yes: `r report_measures(df_measures_hyp001, var_value = value, filter_date = "2019-03-01", filter_group = "learning_disability", filter_category = TRUE)`; 
No: `r report_measures(df_measures_hyp001, var_value = value, filter_date = "2019-03-01", filter_group = "learning_disability", filter_category = FALSE)`) and 
care home status (
Yes: `r report_measures(df = df_measures_hyp001, var_value = value, filter_date = "2019-03-01", filter_group = "care_home", filter_category = TRUE)`; 
No: `r report_measures(df = df_measures_hyp001, var_value = value, filter_date = "2019-03-01", filter_group = "care_home", filter_category = FALSE)`) and 
